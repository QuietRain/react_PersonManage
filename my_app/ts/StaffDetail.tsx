...
export class StaffDetail extends React.Component<any, any>{
    /**
     * 编辑
     */
    handlerEdit() {
        let item:any = {};
        let editTabel = ReactDom.findDOMNode(this.refs["editTabel"]) as any;
        ...
        if (item.name == '' || item.age == '' || item.descrip == '') {
            let tips:any = ReactDom.findDOMNode(this.refs["DtipsUnDone"]);
        ...
        if (!numReg.test(item.age) || parseInt(item.age) > 150) {
            let tips:any = ReactDom.findDOMNode(this.refs["DtipsUnAge"]);
            tips.style.display = 'block';
            setTimeout(function () {
                tips.style.display = 'none';
            }, 1000);
        ...
        //此处应在返回修改成功信息后确认
        let tips:any = ReactDom.findDOMNode(this.refs["Dtips"]);
        tips.style.display = 'block';
        setTimeout(function () {
            tips.style.display = 'none';
        }, 1000);
            ...
            <div>
                ...
                <table ref='editTabel'>
                    <tbody>
                        ...
                        <tr>
                            <th>年龄</th>
                            <td><input id='staffEditAge' type='text' defaultValue={staffDetail.info.name}></input> </td>
                        </tr>
                        <tr>
                            <th>性别</th>
                            <td>
                        ...
                        <tr>
                            <th>个人描述</th>
                            <td><textarea id='staffEditDesript' type='text' defaultValue={staffDetail.info.desrip}></textarea></td>
                        </tr>
                    </tbody>
                </table>
